...
class Hosting extends CI_Controller {
	...
	public function index(){
         $data=array(
			...
			'keywords'=>'عروض استضافة مواقع لينكس, استضافة مواقع, استضافة خادم, حلول الاستضافة, استضافة مشتركة, استضافة افتراضية, استضافة vps',
			'description' =>'بخبرة تفوق العشر سنوات, وباستخدام أحدث تقنيات الاستضافة, نقدم لعملائنا أحدث باقات استضافة المواقع المشتركة.

...

	{
	 ...
	 //echo phpinfo();
...

		{
				...
				$this->load->view('admincms/content/add_content', $data);
...

		{
			...
			$data = array(
			   ...
			   'content' => $this->input->post('main_content'),
			    'content_ar' => $this->input->post('main_content_ar'),
	...
	*/
	...
	function update(){
			...
			if($this->form_validation->run() == false){
				...
				$this->load->view('admincms/content/edit_content', $data);
	...
	/*
	 ...
	 public function setDefaultImage(){
		...
		{	
			...
			$this->load->view('admincms/content/manage_content', $data);



		} // end function manage_content
		...
		function delete_content(){
			...
			redirect('admincms/content/manage_content');
...

		{
			...
			$this->load->view('admincms/content/config', $data);

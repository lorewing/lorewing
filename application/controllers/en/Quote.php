...
//		$this->form_validation->set_rules('Virus_Removal', 'Virus_Removal', '');		
		...
		if ($this->form_validation->run() == FALSE) // validation hasn't been passed
		{
			...
			'description' =>'There are many aspects of web site development, that determine the cost to build it.To request a quote to build your website, please fill in the form below or Call +1-647-680-6263',
		          );
	...
	//recaptch start
		...
		$config = Array(
			...
			{
				$this->session->set_flashdata('message', '<p class=\'success\'>QUOTE was send successfully.</p>');

...
class Social_media extends CI_Controller {
	...
	public function index(){
           $data=array(
			...
			'keywords'=>'اعلانات الفيس بوك المدفوعة,سوشيال ميديا,التسويق من خلال السوشيال ميديا,فيس بوك,تويتر',
			'description' =>'اعلانات الفيس بوك المدفوعة تمكنك من الوصول إلى الشريحة التي تريد دون أن تضيع مجهودك ومالك في استهداف الناس بشكل عام عن طريق تحديد الشريحه المستهدفه.

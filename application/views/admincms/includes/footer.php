 <!-- BEGIN FOOTER -->
        <div class="page-footer">
            <div class="page-footer-inner"><a href="http://www.lorewing.com"> 2016 &copy; Lorewing Web Design Inc.</a>
                </div>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>admin-view2016/assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>admin-view2016/assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>admin-view2016/assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>

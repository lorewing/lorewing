			...
			<div id="form_add">
				...
				<fieldset>
					...
					<legend>Add Sub Menu</legend>
                   		...
                   		<?php echo form_open('/admincms/add_menu/sub_menu'); ?>
                        ...
                        <label>Sub Menu</label>
                            ...
                            <?
                        	$query = $this->db->get_where('menu_name', array('main_link '=>'0','active'=>'1'));
                  ...
                  <label>URL</label>
						...
						echo form_submit(array('name' => 'add_project','id' => 'add_project', 'value' => 'Add Sub Menu', 'class' => 'button radius right small'));

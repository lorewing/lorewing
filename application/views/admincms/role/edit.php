    ...
    <div class="span12">
      <div>
        <ul class="breadcrumb">
          ...
          <li><a href="javascript:void(0);"><?php echo lang('btn_edit');?></a> </li>
        </ul>
      </div>
      <!-- Table -->
      <div class="row-fluid">
        <div class="span12"> 
          ...
          <div class="box" id="box-1">
            <h4 class="box-header round-top"><?php echo lang('btn_edit');?> <?php echo lang('role');?> <a class="box-btn" title="close"><i class="icon-remove"></i></a> <a class="box-btn" title="toggle"><i class="icon-minus"></i></a> <a class="box-btn" title="config" data-toggle="modal" href="#box-config-modal"><i class="icon-cog"></i></a> </h4>
            <div class="box-container-toggle">
              <div class="box-content">
                <?php 			  
							$attributes = array('name' => 'frmRole','id'=>'frmRole','class'=>'form-horizontal');
							echo form_open('admin/roles/update',$attributes);	
							?>
                <fieldset>
                  <div class="control-group">
                    <label class="control-label" for="typeahead"><?php echo lang('role');?> : 	<span class="red">*</span></label>
                    <div class="controls">
                      <input type="text" name="title" class="input-xlarge validate[required]" id="title" value="<?php echo $role[0]->title; ?>" >
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <label class="uniform">
                        <input class="uniform_on" type="checkbox" id="is_default" name="is_default" <?php echo ($role[0]->is_default==true)?"checked=\"checked\"":""?>>
                      </label>
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <label class="uniform">
                        <input class="uniform_on" type="checkbox" id="is_active" name="is_active" <?php echo ($role[0]->is_active==true)?"checked=\"checked\"":""?>>
                      </label>
                    </div>
                  </div>
                  <div class="form-actions">
                    <input type="hidden"  id="role_id" name="role_id" value="<?php echo encodeId($role[0]->id); ?>" />

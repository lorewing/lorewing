...
<head>
    ...
    <meta property="og:url" content="<?php echo base_url(); ?>news/news-detalis/<?php echo $main_title;?>/<?php echo $post_id;?>" /> 
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css_ar/scripts.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css_ar/base.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css_ar/grid.css">
	<link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700" rel="stylesheet" type="text/css">

	<!-- Change Color Stylesheet Here -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css_ar/colors/default.css">


	<!-- TEMPLATE STYLESHEETS -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css_ar/style.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css_ar/layout.css">
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-54aa8388347d0402" async></script>

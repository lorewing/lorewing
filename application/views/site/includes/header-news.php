...
<!-- Mirrored from www.zorbixdesign.com/themes/horizon/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Dec 2014 20:53:30 GMT -->
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title><?php echo $title; ?></title>
    <meta property="og:url" content="<?php echo base_url(); ?>en/news/news-detalis/<?php echo $main_title;?>/<?php echo $post_id;?>" /> 
    <meta property="og:image" content="<?php echo base_url(); ?>private/post/<?php echo $image_name;?>" /> 


    http://www.lorewing.com/en/news/news-detalis/marketing-company-sep/621
    ...
    <meta name="msapplication-TileImage" content="<?php echo base_url(); ?>site_view/img/favicon/ms-icon-144x144.png">
    <meta name="theme-color" content="#ffffff">
    
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">

	<link rel="alternate" href="http://www.lorewing.com/en/home" hreflang="en-ca" />
    <meta name="geo.region" content="CA-ON" />
    <meta name="geo.placename" content="Vaughan" />
    <meta name="geo.position" content="43.840454;-79.551771" />
    <meta name="ICBM" content="43.840454, -79.551771" />
	 
     

	<!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css/scripts.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css/base.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css/grid.css">
	<link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700" rel="stylesheet" type="text/css">

	<!-- Change Color Stylesheet Here -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css/colors/default.css">


	<!-- TEMPLATE STYLESHEETS -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css/style.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>site_view/css/layout.css">
	
    <link rel="canonical" href="http://www.lorewing.com/" />


	<script src="<?php echo base_url(); ?>site_view/js/vendor/modernizr-2.6.2.min.js"></script>
